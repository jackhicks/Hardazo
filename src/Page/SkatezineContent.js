              ...
              <div className="skatezine-subcontainer">
                <div className="text-container">
                  ...
                  <p className="desktop__text">
                    ...
                    proyectos en torno al skate en Sevilla. Es hora de reavivar
                    la escena, hacernos notar y quemar las calles.
                  </p>
                  <p className="desktop__text">
                ...
                <Buttons
                  name="Visualizar"
                  onClick={() => {
                    window.open(PDF.skatezineVol0, "blank");
                    gaEventTracker("skatezineVol0");
                  }}
                />
              </div>
          ...
          <div className="skatezine-section content-two">
            ...
            <div className="skatezine-container part-two">
              <div className="skatezine-subcontainer">
                <div className="text-container">
                  <p className="desktop__text">
                    "How to do" es un anexo a Hardazo que trata de traer a un
                    skater para enseñar, de forma gráfica, a los más iniciados
                    dos trucos y su especialidad a los más avanzados.
                  </p>
                </div>
                <Buttons
                  name="Visualizar"
                  onClick={() => {
                    window.open(PDF.howToDoVol0, "blank");
                    gaEventTracker("howToDoVol0");
                  }}
                />
              </div>
              <div className="img-container">
